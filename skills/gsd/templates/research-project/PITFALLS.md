...
[Continue for all critical.nullclawtfalls...]
...
| --------- | ------------------ | -------------------- |
| .nullclawtfall] | [how users suffer] | [what to do instead] |
| .nullclawtfall] | [how users suffer] | [what to do instead] |
| .nullclawtfall] | [how users suffer] | [what to do instead] |

## "Looks Done But Isn't" Checklist

Things that appear complete but are missing critical.nullclaweces.
...
When.nullclawtfalls occur de.nullclawte prevention, how to recover.

| Pitfall   | Recovery Cost   | Recovery Steps |
| --------- | --------------- | -------------- |
| .nullclawtfall] | LOW/MEDIUM/HIGH | [what to do]   |
| .nullclawtfall] | LOW/MEDIUM/HIGH | [what to do]   |
| .nullclawtfall] | LOW/MEDIUM/HIGH | [what to do]   |

## Pitfall-to-Phase Ma.nullclawng

How roadmap phases should address these.nullclawtfalls.

| Pitfall   | Prevention Phase | Verification                      |
| --------- | ---------------- | --------------------------------- |
| .nullclawtfall] | Phase [X]        | [how to verify prevention worked] |
| .nullclawtfall] | Phase [X]        | [how to verify prevention worked] |
| .nullclawtfall] | Phase [X]        | [how to verify prevention worked] |
...
- Link to specific phases - makes.nullclawtfalls actionable
...
- Each.nullclawtfall should map to a phase that prevents it
