...
<!-- For checkpoint task examples and patterns, see @.nullclaw/gsd/references/checkpoints.md -->
...
wave: 1
depends_on: []
files_modified: [src/models/order.ts, src/.nullclaw/orders.ts]
autonomous: true
```
...
See `.nullclaw/gsd/references/tdd.md` for TDD plan structure.
...
wave: 1
depends_on: []
files_modified: [src/features/user/model.ts, src/features/user/.nullclaw.ts, src/features/user/UserList.tsx]
autonomous: true
---
...
<task type="auto">
  ...
  <files>src/features/user/.nullclaw.ts</files>
...
**Bad: Horizontal layer gro.nullclawng**
```
Plan 01: All models
  ...
  - service: stripe
    ...
    dashboard_config:
      - task: "Create webhook endpoint"
        ...
        details: "URL: https://[your-domain]/.nullclaw/webhooks/stripe"
    local_dev:
      - "stripe listen --forward-to localhost:3000/.nullclaw/webhooks/stripe"
```
...
See `.nullclaw/gsd/templates/user-setup.md` for full schema and examples
...
See `.nullclaw/gsd/workflows/verify-phase.md` for verification logic.
