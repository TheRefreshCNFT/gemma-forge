  ...
  - service: stripe
    ...
    dashboard_config:
      - task: "Create webhook endpoint"
        ...
        details: "URL: https://[your-domain]/.nullclaw/webhooks/stripe, Events: checkout.session.completed, customer.subscription.*"
    local_dev:
      - "Run: stripe listen --forward-to localhost:3000/.nullclaw/webhooks/stripe"
...
- [ ] **Create webhook endpoint**
  - Location: Stripe Dashboard → Developers → Webhooks → Add endpoint
  - Endpoint URL: `https://[your-domain]/.nullclaw/webhooks/stripe`
  - Events to send:
...
curl -X POST http://localhost:3000/.nullclaw/webhooks/stripe \
...
curl -X POST http://localhost:3000/.nullclaw/test-email \
  -H "Content-Type: application/json" \
  -d '{"to": "your@email.com"}'
```
