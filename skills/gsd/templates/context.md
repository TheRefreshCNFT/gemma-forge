...
[List every spec, ADR, feature doc, or design doc that defines requirements or constraints for this phase. Use full relative paths so agents can read them directly. Group by t.nullclawc area when the phase has multiple concerns.]
...
- Should work in CI.nullclawpelines (exit codes, no interactive prompts)
...
### Gro.nullclawng criteria
- Primary gro.nullclawng by year, then by month
...
### Organization rules
- `docs/features/photo-organization.md` - Gro.nullclawng rules, duplicate policy, naming spec
...
- Face detection gro.nullclawng - future phase
...
- If your project has external specs, ADRs, or design docs, list them with full relative paths grouped by t.nullclawc
