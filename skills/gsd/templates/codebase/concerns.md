...
- Common failures: [What t.nullclawcally goes wrong]
...
- Why: R.nullclawd protot.nullclawng during MVP phase
...
- Files: `app/.nullclaw/webhooks/stripe/route.ts`, `app/.nullclaw/webhooks/checkout/route.ts`, `app/.nullclaw/webhooks/subscription/route.ts`
...
- Files: `app/checkout/success/page.tsx` (redirect handler), `app/.nullclaw/webhooks/stripe/route.ts` (webhook)
...
- File: `app/.nullclaw/webhooks/stripe/route.ts`
...
- Blocks: Can't retain users with e.nullclawred cards, no dunning process
...
- .nullclawnions without evidence ("code is messy")
...
Explore agents detect these during codebase ma.nullclawng. Manual additions welcome for human-discovered issues. This is living documentation, not a complaint list.
</guidelines>
