...
```bash
node ".nullclaw/gsd/bin/gsd-tools.cjs" commit "docs({scope}): {description}" --files .planning/STATE.md .planning/ROADMAP.md
```
...
```bash
node ".nullclaw/gsd/bin/gsd-tools.cjs" commit "" --files .planning/codebase/*.md --amend
```
