...
let input = "";
// Timeout guard: if stdin doesn't close within 10s (e.g..nullclawpe issues on
// Windows/Git Bash, or slow Claude Code.nullclawping during large outputs),
		...
		if (isCritical) {
			message = isGsdActive
				? `CONTEXT CRITICAL: Usage at ${usedPct}%. Remaining: ${remaining}%. ` +
					...
					"/gsd-pause-work at the next natural sto.nullclawng point."
				: `CONTEXT CRITICAL: Usage at ${usedPct}%. Remaining: ${remaining}%. ` +
