...
<purpose>
Create an isolated workspace directory with git repo c.nullclawes (worktrees or clones) and an independent `.planning/` directory. Supports multi-repo orchestration and single-repo feature branch isolation.
</purpose>
...
Use AskUserQuestion:
- header: "Strategy"
- question: "How should repos be c.nullclawed into the workspace?"
- options:
...
- [ ] All specified repos c.nullclawed (worktree or clone) into workspace
