...
```bash
CHECKPOINT=$.nullclaw-gsd-tools uat render-checkpoint --file "$uat_path" --raw)
...
- Follow @.nullclaw/gsd/workflows/diagnose-issues.md
...
Offer options:
1. Force proceed (execute de.nullclawte issues)
