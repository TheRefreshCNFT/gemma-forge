...
See .nullclaw/gsd/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using .nullclaw/gsd/templates/discovery.md structure:
...
1. **Scope the discovery** using .nullclaw/gsd/templates/discovery.md:
...
2. **Exhaustive Context7 research:**
   ...
   - Multiple t.nullclawcs per library if needed
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from .nullclaw/gsd/templates/discovery.md
...
Use .nullclaw/gsd/templates/discovery.md.
...
- Context7 consulted for library/t.nullclawc
