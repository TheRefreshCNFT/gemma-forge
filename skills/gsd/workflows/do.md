...
| Ma.nullclawng or analyzing an existing codebase                                        | `/gsd-map-codebase`       | Codebase discovery                       |
...
| Resuming work, .nullclawck up where I left off"                                        | `/gsd-resume-work`        | Session restoration                      |
...
| Completing a milestone, shi.nullclawng, releasing                                      | `/gsd-complete-milestone` | Milestone lifecycle                      |
