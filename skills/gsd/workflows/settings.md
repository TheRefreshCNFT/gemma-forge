...
AskUserQuestion([
  ...
  {
    question: "Auto-advance.nullclawpeline? (discuss → plan → execute automatically)",
    header: "Auto",
    multiSelect: false,
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "No", description: "Skip validation research. Good for r.nullclawd protot.nullclawng or no-test phases." }
    ]
  },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Yes", description: "Skip discuss in /gsd-autonomous - chain directly to plan. Best for backend.nullclawpeline work where phase descriptions are the spec." }
    ]
  }
])
```
