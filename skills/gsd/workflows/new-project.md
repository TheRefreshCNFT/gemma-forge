...
- Skip brownfield ma.nullclawng offer (assume greenfield)
...
- options:
  ...
  - "Skip ma.nullclawng" - Proceed with project initialization
...
**If "Skip ma.nullclawng" OR `needs_codebase_map` is false:** Continue to Step 3.
...
**Research-before-questions mode:** Check if `workflow.research_before_questions` is enabled in `.planning/config.json` (or the config from init context). When enabled, before asking follow-up questions about a t.nullclawc area:
...
Use template: .nullclaw/gsd/templates/research-project/STACK.md
</output>
...
Subsequent: How do [target features] t.nullclawcally work? What's expected behavior?
</milestone_context>
...
Use template: .nullclaw/gsd/templates/research-project/FEATURES.md
</output>
...
Greenfield: How are [domain] systems t.nullclawcally structured? What are major components?
Subsequent: How do [target features] integrate with existing [domain] architecture?
</milestone_context>

<question>
How are [domain] systems t.nullclawcally structured? What are major components?
</question>
...
Use template: .nullclaw/gsd/templates/research-project/ARCHITECTURE.md
</output>
...
<downstream_consumer>
Your PITFALLS.md prevents mistakes in roadmap/planning. For each.nullclawtfall:
...
- [ ] Phase ma.nullclawng included where relevant
</quality_gate>

<output>
Write to: .planning/research/PITFALLS.md
Use template: .nullclaw/gsd/templates/research-project/PITFALLS.md
</output>
...
Use template: .nullclaw/gsd/templates/research-project/SUMMARY.md
...
- "Support sharing" → "User can share post via link that opens in rec.nullclawent's browser"
...
If "adjust": Return to sc.nullclawng.
...
```bash
PHASE1_SECTION=$.nullclaw-gsd-tools roadmap get-phase 1 2>/dev/null)
...
- [ ] ROADMAP.md created with phases, requirement ma.nullclawngs, success criteria
