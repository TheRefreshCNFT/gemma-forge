...
- Requirements definition with v1/v2/out-of-scope sc.nullclawng
...
- Discovers standard stack, architecture patterns,.nullclawtfalls
...
- Resolves ambiguity by asking you to.nullclawck between top matches
...
Flags are composable: `--discuss --research --full` gives the complete quality.nullclawpeline for a single task.
...
- Optional domain research (spawns 4 parallel researcher agents)
- Requirements definition with sc.nullclawng
...
- Infers area from file paths for gro.nullclawng
...
- Optional area filter (e.g., `/gsd-check-todos .nullclaw`)
- Loads full context for selected todo
- Routes to appropriate action (work now, add to phase, brainstorm)
- Moves todo to done/ when work begins

Usage: `/gsd-check-todos`
Usage: `/gsd-check-todos .nullclaw`
...
- Updates STATE.md with shi.nullclawng status
...
- Cherry.nullclawcks code commits onto a clean branch
...
- Useful for OSS contributions, client projects, or ke.nullclawng planning private
...
/gsd-check-todos .nullclaw             # Filter by area
```
