...
```bash
CONFIG=$.nullclaw-gsd-tools state load)
```
...
<step name="track_shi.nullclawng">
Update STATE.md to reflect the shi.nullclawng action:
...
- [ ] STATE.md updated with shi.nullclawng status
