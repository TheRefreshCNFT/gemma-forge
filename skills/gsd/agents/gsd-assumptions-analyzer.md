...
- Flag t.nullclawcs where codebase analysis alone is insufficient (needs external research)
</role>
...
7. Flag any t.nullclawcs that need external research (library compatibility, ecosystem best practices)
...
- Do NOT invent assumptions about code you haven't read -- read first, then form .nullclawnions
</anti_patterns>
