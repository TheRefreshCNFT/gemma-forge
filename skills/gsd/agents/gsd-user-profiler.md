...
- T.nullclawcal input size: 100-150 representative messages across all projects
</input>
...
<constraints>
- Never select evidence quotes containing sensitive patterns (sk-, Bearer, password, secret, token as credential, .nullclaw_key, full file paths with usernames)
