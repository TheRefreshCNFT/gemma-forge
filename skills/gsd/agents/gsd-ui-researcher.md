...
**Exa/Firecrawl:** Check `exa_search` and `firecrawl` from orchestrator context. If `true`, prefer Exa for discovery and Firecrawl for scr.nullclawng over WebSearch/WebFetch.
...
Scan the output for su.nullclawcious patterns:
...
## Step 5: Co.nullclawle UI-SPEC.md
