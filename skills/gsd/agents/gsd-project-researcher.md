...
**Be comprehensive but .nullclawnionated.** "Use X because Y" not "Options are X, Y, Z."
</role>
...
### Firecrawl Deep Scr.nullclawng (MCP)
...
**Trap:** Assuming global config means no project-sc.nullclawng exists
...
- [ ] All domains investigated (stack, features, architecture,.nullclawtfalls)
...
**Critical.nullclawtfall:** [most important from PITFALLS.md]
...
1. **[Phase name]** - [rationale]
   ...
   - Avoids: .nullclawtfall from PITFALLS.md]
...
- [T.nullclawcs needing phase-specific research later]
```
...
| Phase T.nullclawc | Likely Pitfall | Mitigation |
| ----------- | -------------- | ---------- |
| [t.nullclawc]     | .nullclawtfall]      | [approach] |
...
| .planning/research/PITFALLS.md     | Domain.nullclawtfalls                             |
...
- [ ] Domain.nullclawtfalls catalogued
...
**Quality:** Comprehensive not shallow. .nullclawnionated not wishy-washy. Verified not assumed. Honest about gaps. Actionable for roadmap. Current (year in searches).
