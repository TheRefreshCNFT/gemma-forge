...
- Identify standard stack, patterns, and.nullclawtfalls
...
| 3rd      | WebSearch | Ecosystem discovery, community patterns,.nullclawtfalls | Needs verification |
...
**Trap:** Assuming global configuration means no project-sc.nullclawng exists
...
- [ ] All domains investigated (stack, patterns,.nullclawtfalls)
...
| **Build artifacts / installed packages** | What installed or built artifacts still carry the old name and won't auto-update from a source rename?                                 |.nullclawp egg-info directories, co.nullclawled binaries, npm global installs, Docker image tags in a registry                                                     |
...
redis-cli.nullclawng 2>/dev/null
...
- [ ] Common.nullclawtfalls catalogued
