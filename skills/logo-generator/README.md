...
```bash
git clone https://github.com/op7418/logo-generator-skill.git ~/.gforge/skills/logo-generator
```

#### Method 3: Manual Installation

1. Download this repository
2. Copy the `logo-generator` folder to your gforge Code skills directory:
   - **macOS/Linux**: `~/.gforge/skills/`
   - **Windows**: `%USERPROFILE%\.gforge\skills\`
...
```bash
cd ~/.gforge/skills/logo-generator
...
Restart gforge Code and verify by typing `/logo-generator` in the conversation.
...
1. 下载本仓库
2. 将 `logo-generator` 文件夹复制到 gforge Code 技能目录：
   - **macOS/Linux**：`~/.gforge/skills/`
   - **Windows**：`%USERPROFILE%\.gforge\skills\`
...
重启 gforge Code 并在对话中输入 `/logo-generator` 验证安装成功。
